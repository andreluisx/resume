  ...
  return (
    <div className="relative w-full min-h-screen bg-gray-900 overflow-hidden ">
      ...
      <div className="absolute inset-0">
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500 rounded-full filter blur-[100px] opacity-20"
          animate={{
            scale: [1, 1.3, 1],
            x: [50, -50, 50],
            y: [0, -50, 0],
      ...
      <div className="relative z-10 container mx-auto px-6 h-screen flex flex-col justify-center">
        ...
        >
          ...
          >
            Transformo ideias em soluções digitais escaláveis, com código limpo
            e foco total em experiência do usuário. Conecto tecnologia a
            resultados reais para empresas que querem ir além.
          </motion.p>
    ...
    <div className="absolute right-0 top-1/2 transform -translate-y-1/2 hidden lg:block">
      {snippets.map((snippet, i) => (
        ...
        >
          ...
          <pre className="text-blue-400 text-sm font-mono">{snippet.code}</pre>
        </motion.div>
      ))}
    </div>
  );
