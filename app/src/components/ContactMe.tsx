...
const ContactSection = () => {
  return (
    <section id="contato" className="py-20 bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      <div className="container mx-auto px-6 max-w-4xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl mb-8 leading-relaxed">
            Se você está procurando um profissional dedicado, criativo e apaixonado por transformar ideias em realidade, 
            <span className="font-semibold text-blue-300"> você acabou de encontrá-lo.</span> Estou pronto para colaborar em projetos desafiadores e entregar soluções que superem expectativas.
          </p>
          ...
          <div className="bg-gray-800 rounded-lg p-8 shadow-xl border border-gray-700 transform hover:scale-105 transition-transform duration-300">
            <h3 className="text-2xl font-bold mb-6 text-blue-300">Disponível para oportunidades:</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-blue-300">Entre em Contato</h3>
            <p className="text-gray-300">
              Quer discutir um projeto, tirar dúvidas ou apenas bater um papo sobre tecnologia? 
